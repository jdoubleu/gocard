...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/MembersApi~addMembersToRegisterCallback
     ...
     * @param {module:api/MembersApi~addMembersToRegisterCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/MembersApi~deleteMemberOfRegisterCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MembersApi~deleteMemberOfRegisterCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/MembersApi~findMembersByRegisterCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} registerId ID of the register
     * @param {module:api/MembersApi~findMembersByRegisterCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/MembersApi~getMemberByRegisterCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MembersApi~getMemberByRegisterCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/MembersApi~updateMembersOfRegisterCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/MembersApi~updateMembersOfRegisterCallback} callback The callback function, accepting three arguments: error, data, response
     */
