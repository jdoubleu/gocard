    ...
    return (
        <Row>
            <Col sm={12} md={{size: 10, offset: 1}}>
                ...
                <Card>
                    <CardHeader>
                        <Nav tabs className="card-header-tabs mx-auto">
                            <NavItem>
                    ...
                    <CardBlock>
                        ...
                        <CardText className="px-2 text-justify">
                            ...
                            <Col className="px-4 text-justify">
                                <Row className="mb-1">
                                    Single Choice(Es gibt mehere Antwortemöglichkeiten aber nur eine Antwort ist die
                                    Richtige)
                                </Row>
                                <Row className="mb-1">
                                    Multiple Choice(Es gibt mehere Antwortmöglichkeiten und es können mehere richtig
                                    sein)
                                </Row>
                                <Row className="mb-1">
                                    Selbstkontrolle(Du beantwortest die Frage selbst für dich im Kopf und vergleichst
                                    deine Antwort anschließend mit der angezeigten richtigen Antwort. Danach bewertest
                                    du
                                    deine Antwort mit richtig oder Falsch)
                                </Row>
                                <Row className="mb-1">
                                    Texteingabe (Du gibst eine Antwort in das Textfeld ein und deine Antwort wird mit
                                    der
                        ...
                        <CardText className="px-2 text-justify">
                            Eine Karteikarte wird immer für ein Register erstellt. Wähle also erst das Register aus in
                            dem du die neue Karteikarte erstellen möchtest.
                            In der Registerdetail Ansicht ist die obere linke Karte ähnlich wie beim Dashboard dafür da
                            ...
                            erscheint ein Formular. In diesem Formular muss die Antwort angeben werden und es kann ein
                            oder mehrere Tags angeben werden. Bei den Single und Multiple Choice Formular kann man
                            durch den Knopf + kann eine neue Antwortmöglichkeit hinzugefügt werden. Bei den Fragetypen
                            Selbstkontrolle und Texteingabe gibt es für die Antwort ein Textfeld.
                            <br/>
                            Bei Single und Multiple Choice müssen die richtigen Antworten angehakt werden. Desweitern
                        ...
                        <CardText className="px-2 text-justify">
                            ...
                            Anschießend hast du das selbe Formular wie bei dem erstellen einer Karteikarte. Du kannst
                        ...
                        <CardText className="px-2 text-justify">
                            Tags sind dazu da, um deine Karteikarten zu strukturieren. Sie sollen deine Karteikarten in
                            feinere Kategorien unterteilen.
                            Beispiel: Register.Deutsch Karteikarten Frage: Wer hat Kabale und Liebe geschreiben Tags:
                            Autoren, Sturm und Drang, Schiller
                            Jeder Karteikarten können beliebig viele Tags zugeordnet werden. Die Tags werden innerhalb
                        ...
                        <CardText className="px-2 text-justify">
                            Ein Register ist eine Sammulung von beliebig vielen Karteikarten. Diese Sammlung kann ein
                            ...
                            diese einlädst. Du kannst jedem Mitglied in deinem Register für dieses Register bestimmte
                        ...
                        <CardText className="px-2 text-justify">
                            ...
                            Beispiel: In einem Register, in dem es um das Fach Betriebswirtschaftslehre geht, nennt man
                            das Register: BWL oder Betriebswirtschaftslehre
                            Ein guter Titel hilft dir und andern, mit den du das Register teilst, schnell zu verstehen
                            worum es in diesem Register geht.
                            <br/>
                            In dem Bereich Beschreibung kannst du dann das Thema dieses Registers genauer beschreiben.
                            Die Beschreibung wird in der Registerdetail Ansicht angezeigt und
                            soll dir und andern Leuten helfen ein genaues verständniss davon zu haben worum es in diesem
                            Register geht
                            <br/>
                            Die letzte Sache die du beim Erstellen eines Registers angeben kannst sind Mitglieder die
                        ...
                        <CardText className="px-2 text-justify">
                            ...
                            Registerdetail Ansicht. Dort gibt es unter der Beschreibung keinen Link "Bearbeiten". Klicke
                        ...
                        <CardText className="px-2 text-justify">
                            In der Registerdetail Ansicht befinden sich alle relevaten Informationen zu dem Register. In
                            ...
                            diesem
                            Register und falls sich noch weitere Mitglieder in dem Register befinden, werden diese durch
                            die kürzel angezeigt. Unter der Leiste befinden sich alle Karten, die sich in dem Register
                            befinden.
                        </CardText>
                        ...
                        <CardText className="px-2 text-justify">
                            Zum Lernen wähle das Register aus in dem sich die Karten befinden, die du lernen möchtest.
                            ...
                            alle sich in dem Register befindliche Karten lernen. Um deine Auswahl zu Filtern kannst du
                            überhalb der Lernvarianten die Tags auswählen. Wenn du Tags ausgewählt hast werden nur die
                            Karten die den Tag haben zum lernen ausgewählt. Eine Karte muss nur einen der Ausgewählten
                        ...
                        <CardText className="px-2 text-justify">
                            ...
                            <Col className="px-4 text-justify">
                                ...
                                <Row className="mb-1">
                                    ...
                                    nicht" bewertet sind und man bekommt dirket Angezeigt ob die Antwort Richtig oder
                                    Falsch ist)
                                </Row>
                                <Row className="mb-1">
                                    3. Klausur (in diesem Modus werden alle ausgewählten Karten gelernt man bekommt nur
                        ...
                        <CardText className="px-2 text-justify">
                            Auf jeder Seite findest du oben rechts deinen Namenskürzel in Form eines Icons und deinen
                            Anzeigenamen. Durch klicken auf den Namen oder das Icon kommst du zur
                            Profilverwaltung. Auf dieser Seite hast du eine Auflistung deiner Accountdaten. Du kannst
                        ...
                        <CardText className="px-2 text-justify">
                            ...
                            Hochschule Düsseldorf. Die Studenten der Hochschule Düsseldorf können sich über Shibboleth
                            mit
                            ihren Hochschul Account anmelden.
                            <br/>
                            Zwischen den beiden Accounts gibt es sonst keine unterschiede. Es gibt keine Vorteile durch
                        ...
                        <CardText className="px-2 text-justify">
                            ...
                            teile am besten den Leuten die dich zu Registern einladen wollen auch deine E-Mail Adresse
                            mit.
                        ...
                        <CardText className="px-2 text-justify">
                            Für den Login gebe die E-Mail Adresse des Accounts und das zu dem Account gehörige Passwort
                            ein. Wenn ein Fehler auftritt überprüfe, ob du die richtige E-Mail und das richtige
                            Passwort eingeben hast. Wenn du dein Passwort vergessen hast klicke auf Passwort vergessen.
                        ...
                        <CardText className="px-2 text-justify">
                            Wenn du dein Passwort vergessen hast aber deine E-Mail Adresse noch kennst, kannst du dein
                            Passwort zurücksetzten. Das Passwort wird zurückgesetzt indem du eine E-Mail bekommst
                            mit einem neuen Passwort zugeschickt bekommst. Nutze dieses Passwort, um dich einzuloggen.
                        ...
                        <CardText className="px-2 text-justify">
                            ...
                            Passwort. Das Passwort muss man in dem Passwort wiederholen Eingabefeld nochmals bestätigen.
                        ...
                        <CardText className="px-2 text-justify">
                            Auf dem Dashboard befinden sich alle Register zu denen du zugang hast. Also nicht nur die
                        ...
                        <CardText className="px-2 text-justify">
                            Im oberen Bereich der Seite baut sich vom Dashboard aus eine Navigationzeile zusammen, die
                            dir deinen Weg bis zu der Seite, auf der du dich befindest anzeigt. Durch das Klicken auf
                            einen
                        ...
                        <CardText className="px-2 text-justify">
                            ...
                            was mit deinen Daten passiert. Die <a href="eula">EULA</a> solltest du lesen, um zu wissen
