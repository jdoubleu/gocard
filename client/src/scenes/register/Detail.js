            ...
            <div>
                ...
                <CardGroup>
                                ...
                                <ButtonGroup check>
                                    <Link to="/normal">
                                        <Button id="buttonNormal" outline
                                                onClick={() => this.onRadioBtnClick(1)} active={this.state.mode === 1}
                                                color={this.state.mode === 1 ? 'primary' : 'secondary'}>Normal
                                        </Button>
                                    </Link>

                                    <Button id="buttonPower" outline
                                            onClick={() => this.onRadioBtnClick(2)} active={this.state.mode === 2}
                                            color={this.state.mode === 2 ? 'primary' : 'secondary'}>Power
                                    </Button>
                                    <Button id="buttonKlausur" outline
                                            onClick={() => this.onRadioBtnClick(3)} active={this.state.mode === 3}
                                            color={this.state.mode === 3 ? 'primary' : 'secondary'}>Klausur
                                    </Button>
                                </ButtonGroup>
                            </FormGroup>
                            <Link to={this.start()}>
                    ...
                    <Card block>
                        ...
                        <CardText>
                            <MemberBar
                                members={["Lewis", "nicki lauder", "peter maffay", "Udo", "Dimo Bibbers", "Ingo Dingo", "Tarzan", "Balu Bär"]}/>
                        </CardText>
                    </Card>
                </CardGroup>
